  ...
  <div>
    <div class="weui-form">
          ...
          <div class="weui-cells">
            <label for="js_input1" class="weui-cell weui-cell_active">
              ...
              <div class="weui-cell__bd">
                <input id="js_input1" class="weui-input" v-model="userInfo.email" placeholder="请输入邮箱地址"/>
              </div>
            </label>
            <label for="js_input1" class="weui-cell weui-cell_active">
              ...
              <div class="weui-cell__bd weui-flex">
                ...
                <input style="margin-top: 5%" id="js_input3" class="weui-input" placeholder="请输入验证码"
                       v-model="userInfo.verification"/>
                <button style="width: 200px" id="js_btn_vcode" role="button"
            ...
            <label for="js_input1" class="weui-cell weui-cell_active">
              <div class="weui-cell__hd"><span class="weui-label">登陆账号</span></div>
              <div class="weui-cell__bd">
                <input id="js_input2" class="weui-input" placeholder="请输入登陆账号" v-model="userInfo.account"/>
              </div>
            </label>
            <label for="js_input1" class="weui-cell weui-cell_active">
              <div class="weui-cell__hd"><span class="weui-label">登陆密码</span></div>
              <div class="weui-cell__bd">
                <input id="js_input4" class="weui-input" placeholder="请输入登陆密码" v-model="userInfo.password"/>
              </div>
            </label>
            <label for="js_input1" class="weui-cell weui-cell_active">
              <div class="weui-cell__hd"><span class="weui-label">确认密码</span></div>
              <div class="weui-cell__bd">
                <input id="js_input5" class="weui-input" placeholder="请确认密码" v-model="userInfo.password1"/>
              </div>
            </label>
          </div>
        </div>
      ...
      <div class="weui-form__opr-area" @click="confirm">
        <a role="button" class="weui-btn weui-btn_primary weui-btn"
           href="javascript:" id="showTooltips">注册</a>
      </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      confirm() {
        let message = "";
        if ("" == this.userInfo.passwrod1)
          message = "确认密码不能为空";
        if ("" == this.userInfo.password)
          message = "密码不能为空";
        if ("" == this.userInfo.account)
          message = "登录账号不能为空";
        if ("" == this.userInfo.verification)
          message = "验证码不能为空";
