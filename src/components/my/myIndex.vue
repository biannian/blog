  ...
  <div>
    <div style="position: fixed;transition: 0.5s;z-index: 1001" id="topImg" class="top1">
      <div class="top-nav1">
        ...
        <span style="margin-left: 38%"> <i class="el-icon-setting" id="showIOSActionSheet"></i></span>
      </div>
    </div>
    <!--    头像 已登录-->
    <div style="border-bottom: 1px solid #e5e5e5;height: 180px;background-color: #fafafa;">
      ...
      <div style="padding: 60px 0px 0 30px;">
        ...
        <p style="font-size: 14px;padding: 0px 0 0 60px">微博号：{{user.account}}</p>
    ...
    <div>
      ...
      <div role="dialog" aria-modal="true" tabindex="0" aria-hidden="true" class="weui-actionsheet" id="iosActionsheet">
        ...
        <div class="weui-actionsheet__menu">
          <div id="current1" tabindex="0" role="button" class="weui-actionsheet__cell">修改信息</div>
          <div role="button" tabindex="0" class="weui-actionsheet__cell">切换账户</div>
          <div role="button" tabindex="0" @click="logout" class="weui-actionsheet__cell weui-actionsheet__cell_warn">注销账户</div>
        </div>
